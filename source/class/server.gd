...
func updatetimerdisplay():
	...
	player.timerdisplay.text="0"+str(mins)+":"+str(int(round_timer.time_left-(mins*60))if int(round_timer.time_left-(mins*60))>9 else "0"+str(int(round_timer.time_left-(mins*60))));
