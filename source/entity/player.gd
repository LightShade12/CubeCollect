...
#private
@onready
var sub_viewport_container: SubViewportContainer = $Control/CanvasLayer/hudControl/SubViewportContainer
@onready var head: Node3D = $head
@onready
var healthdisplay: Label = $Control/CanvasLayer/hudControl/SubViewportContainer/SubViewport/movableHudControl/healthdispbg/healthtxt/healthdisplay
@onready
var interaction_hint_dislpay: Label = $Control/CanvasLayer/hudControl/SubViewportContainer/SubViewport/movableHudControl/interactionHintDislpay
...
@onready
var movable_hud_control: Control = $Control/CanvasLayer/hudControl/SubViewportContainer/SubViewport/movableHudControl
...
#public
@onready
var typetooltip: Label = $Control/CanvasLayer/hudControl/SubViewportContainer/SubViewport/movableHudControl/typetooltip

@onready
var cubecountdisplay: Label = $Control/CanvasLayer/hudControl/SubViewportContainer/SubViewport/movableHudControl/cubestxt/cubecountdisplay

@onready
var playermessagedisplay: Label = $Control/CanvasLayer/hudControl/SubViewportContainer/SubViewport/movableHudControl/playermessagedisplay
@onready
var objectivesdisplay: Label = $Control/CanvasLayer/hudControl/SubViewportContainer/SubViewport/movableHudControl/currentobjectivetext/objectivesdisplay

@onready
var timerdisplay: Label = $Control/CanvasLayer/hudControl/SubViewportContainer/SubViewport/movableHudControl/timerdisplay
@onready
var sub_viewport: SubViewport = $Control/CanvasLayer/hudControl/SubViewportContainer/SubViewport
@onready var texture_rect: TextureRect = $Control/CanvasLayer/hudControl/TextureRect
...
func _ready() -> void:
	sub_viewport_container.self_modulate = Color.TRANSPARENT
...
func _process(delta: float) -> void:
	...
	texture_rect.material.set_shader_parameter("SCREEN_TEXTURE", sub_viewport.get_texture())
	time += delta
